...
const dataAdmin = new AdminWaletNode(id, );


class AdminWaletList {
    constructor() {
        this.head = null;
        this.tail = null;
    }

    append( id, admin_id, belence = 0
    ) {
        const newNode = new AdminWaletNode({
            id,
            admin_id,
            belence,
            updated_at: new Date()
...
const adminWaletList = new AdminWaletList();
